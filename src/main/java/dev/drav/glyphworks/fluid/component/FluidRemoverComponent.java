 ...
 *
 * <p>Defines where in block-local space the remover reads world fluid from.
 ...
 *
 * <p>The block's OUTPUT grid face connects to the fluid network — this is
...
public final class FluidRemoverComponent implements Component<ChunkStore> {
    ...
    public static final BuilderCodec<FluidRemoverComponent> CODEC = BuilderCodec
            ...
            .append(
                    new KeyedCodec<>("FluidRemover_TargetPosition", Vector3i.CODEC),
