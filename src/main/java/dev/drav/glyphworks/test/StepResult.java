 ...
 *
 * <ul>
 *   <li>{@link #DONE} – step finished successfully; advance to the next step.</li>
 *   <li>{@link #PENDING} – step is still running; re-run next tick.</li>
 *   <li>{@link #failed(String)} – step failed; record the reason and move to the next test.</li>
 * </ul>
 */
public final class StepResult {

    private enum Kind { DONE, PENDING, FAILED }
    ...
    public boolean isFailed()  { return kind == Kind.FAILED;  }
