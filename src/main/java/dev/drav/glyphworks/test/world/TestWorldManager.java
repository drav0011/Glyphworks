 ...
 *
 * <p>
 * Each run gets its own world (name: {@code glyphworks-test-<runId>}) generated
 * by {@link VoidWorldGenProvider} with {@code deleteOnRemove=true}, so no disk
 * state is left behind after the run.
 */
