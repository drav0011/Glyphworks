 ...
 * loaded, the block entity doesn't exist, or the block has no {@link GridComponent}.
 *
 * <p>Filler cells of multi-block structures are transparently redirected to their
 * origin block before the component lookup, so callers never need to handle fillers.
 */
